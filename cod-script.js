/* =========================================================
   ...
   ========================================================= */
const GF_DATA_URL = "cod-gunfight-data.csv";
const GF_FALLBACK_URL = "cod-gunfight-data.csv";
const TM_DATA_URL = "cod-team-matches-data.csv";
  ...
  standings.sort((a, b) => b.wins - a.wins).forEach(p => {
    ...
    card.innerHTML = `
      ...
      <div class="driver-card__grid">
        ...
        <div class="driver-card__metric"><span>Avg Damage</span><span>${p.avgDamage}</span></div>
      </div>
    `;
